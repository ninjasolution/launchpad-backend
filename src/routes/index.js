...
router.get("/project/dashboard", projectController.dashboard)
...
router.get("/project/get-proof/:projectId",  middlewares.authJwt.verifyToken, projectController.getProof)
